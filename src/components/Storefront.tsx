                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {finalProcessed.map(p => {
                    ...
                    return (
                      ...
                      >
                         {isFeatured && (
                           <div className="absolute -top-3 left-6 bg-[#B8791A] text-white text-[9px] font-black tracking-widest px-3 py-1 rounded-full uppercase shadow-md flex items-center gap-1.5 animate-pulse">
