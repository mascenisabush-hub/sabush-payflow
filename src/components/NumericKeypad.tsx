    ...
    <div className="fixed inset-0 z-[110] bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="space-y-1 text-left">
          <span className="text-[9px] font-black uppercase tracking-widest text-[#D4AF37] leading-none">Teclado Numérico</span>
        ...
        <div className="pt-3 border-t border-slate-100 flex gap-3">
          ...
          <button
            ...
            className="flex-1 py-3.5 bg-[#D4AF37] text-white rounded-2xl font-black text-xs hover:bg-[#D4AF37] transition-all cursor-pointer border-none flex items-center justify-center gap-1.5 uppercase tracking-wider shadow-md hover:shadow-lg"
          >
