        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 bottom-12 md:bottom-auto md:top-12 mt-2 w-80 bg-[#03213F] border border-white/15 rounded-2xl shadow-xl overflow-hidden z-50 p-5 text-left text-white"
            >
                      ...
                      <div className="w-[20px] h-[20px] flex items-center justify-center shrink-0">
                        <item.icon 
                          ...
                          className={cn(
                            ...
                            isActive ? "text-white" : "text-[#E6F1FB]/80 group-hover:text-white"
                          )}
                        />
                      </div>
