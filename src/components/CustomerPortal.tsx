    ...
    <div className="min-h-screen w-full bg-[#0A1C38] text-slate-100 flex flex-col font-sans relative overflow-x-hidden antialiased">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 py-6 flex flex-col items-center justify-center relative z-10 sm:px-6 sm:py-8">
        ...
        {loadingAuth ? (
          ...
          >
            {/* Visual shine */}
            <div className="absolute top-0 left-0 w-full h-1.5 bg-[#0A1C38]"></div>
            ...
            {showResets ? (
              ...
              <div className="space-y-4" id="forgot-password-panel">
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-[#0A1C38] hover:bg-[#06142A] text-white font-bold rounded-xl text-xs transition-all tracking-wide uppercase shadow-lg flex items-center justify-center gap-2 cursor-pointer"
                >
