  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#FAF7F2] pb-6">
        ...
        <div className="flex flex-wrap p-1 bg-[#FAF7F2] border border-[#E9E1D2] rounded-2xl w-fit gap-1">
          <button
      ...
      {activeTab === 'general' ? (
              ...
              <div className="h-[300px]">
                 <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                    <AreaChart data={revenueData}>
                       ...
                       <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{fill: '#8b735f', fontSize: 12}} />
                       <YAxis axisLine={false} tickLine={false} tick={{fill: '#8b735f', fontSize: 12}} />
                       <Tooltip 
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                    <BarChart data={categoryChartData}>
                      ...
                      <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{fill: '#8b735f', fontSize: 11}} />
                      <YAxis axisLine={false} tickLine={false} tick={{fill: '#8b735f', fontSize: 11}} />
                      <Tooltip 
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
          <div className="bg-[#FAF7F2] border border-[#E9E1D2] p-8 rounded-[40px] shadow-sm text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 border-b border-[#E9E1D2]/60">
