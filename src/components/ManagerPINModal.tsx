        ...
        {isRequestingRemote ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6 animate-in fade-in duration-200">
            ...
            <button
              ...
              className="w-full py-3.5 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-95 shadow-md shadow-blue-500/10"
            >
